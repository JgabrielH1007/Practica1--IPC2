...
public class FramePrincipal extends javax.swing.JFrame {
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        // TODO add your handling code here:
        InterlFrameLisTarjetas listTarjet = new InterlFrameLisTarjetas();
        listTarjet.pack();
    
    // Añadir el JInternalFrame al JDesktopPane
        jDesktop.add(listTarjet);
    
    // Hacer visible el JInternalFrame
        listTarjet.setVisible(true);
    
    // Ajustar el tamaño del JDesktopPane al tamaño del JInternalFrame
        jDesktop.setPreferredSize(new Dimension(listTarjet.getWidth(), listTarjet.getHeight()));
